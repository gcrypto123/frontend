...
const Matrix4Team = ({rowData}) =>{ 
    ...
    return <><Container fluid className="px-6 py-6 mt-6">
        <Row className='mb-6'>
            <Team colConfig={Columns} rowData={formatedRowData} tableName="Matrix Team-4 (Level-1)" />
        </Row>
        <Row>
            <Team colConfig={Columns} rowData={formatedRowData} tableName="Matrix Team-4 (Level-2)" />
        </Row>
    </Container></>
