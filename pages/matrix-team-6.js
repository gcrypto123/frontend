...
const Matrix6Team = ({rowData}) =>{ 
    ...
    return <><Container fluid className="px-6 py-6">
        <Row className='mb-6'>
            <Team colConfig={Columns} rowData={formatedRowData} tableName="Matrix Team-6 (Level-1)" />
        </Row>
        <Row>
            <Team colConfig={Columns} rowData={formatedRowData} tableName="Matrix Team-6 (Level-2)" />
        </Row>
    </Container></>
